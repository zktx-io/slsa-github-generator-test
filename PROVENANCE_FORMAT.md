...
```json
"builder": {
  "id": "https://github.com/zktx-io/slsa-github-generator-test/.github/workflows/builder_go_slsa3.yml@refs/tags/v0.0.1"
}
```
...
- [Golang BuildConfig Format](https://github.com/zktx-io/slsa-github-generator-test/blob/main/internal/builders/go/README.md#buildconfig-format).
