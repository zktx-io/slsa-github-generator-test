...
Before using the Maven publish action, you should have a workflow that invokes the [Maven builder](https://github.com/zktx-io/slsa-github-generator-test/blob/main/internal/builders/maven/README.md). It will look something like this:
...
publish:
  ...
  steps:
    - name: publish
      id: publish
      uses: zktx-io/slsa-github-generator-test/actions/maven/publish@v2.0.0
      with:
