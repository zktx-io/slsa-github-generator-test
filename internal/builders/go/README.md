...
In practice, most triggers should work with the exception of `pull_request`. If you would like support for `pull_request`, please tell us about your use case on [issue #358](https://github.com/zktx-io/slsa-github-generator-test/issues/358). If you have an issue with any other triggers please submit a [new issue](https://github.com/zktx-io/slsa-github-generator-test/issues/new/choose).
...
If you think you need support for other variables, please [open an issue](https://github.com/zktx-io/slsa-github-generator-test/issues/new).
  ...
  strategy:
    matrix:
      ...
      arch:
        - amd64
        - arm64
  uses: zktx-io/slsa-github-generator-test/.github/workflows/builder_go_slsa3.yml@v2.0.0
  with:
    go-version: 1.19
...
The builder workflow [zktx-io/slsa-github-generator-test/.github/workflows/builder_go_slsa3.yml](https://github.com/zktx-io/slsa-github-generator-test/blob/main/.github/workflows/builder_go_slsa3.yml) accepts the following inputs:
...
The builder workflow [zktx-io/slsa-github-generator-test/.github/workflows/builder_go_slsa3.yml](https://github.com/zktx-io/slsa-github-generator-test/blob/main/.github/workflows/builder_go_slsa3.yml) provides the following outputs:
...
```json
{
  ...
  "predicate": {
    "builder": {
      "id": "https://github.com/zktx-io/slsa-github-generator-test/.github/workflows/builder_go_slsa3.yml@v1.4.0"
    },
    "buildType": "https://github.com/zktx-io/slsa-github-generator-test/go@v1",
    "invocation": {
      "configSource": {
