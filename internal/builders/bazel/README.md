...
jobs:
  build:
    ...
    uses: zktx-io/slsa-github-generator-test/.github/workflows/builder_bazel_slsa3.yml@v2.0.0
    with:
...
| Name                               | Value                                                                                                                 | Description                                                                                                                                                                                                            |
| ---------------------------------- | --------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `runDetails.builder.id`            | `https://github.com/zktx-io/slsa-github-generator-test/.github/workflows/builder_bazel_slsa3.yml@refs/tags/v1.7.0"` | Identifies the Bazel builder                                                                                                                                                                                           |
| `buildDefinition.buildType`        | `"https://github.com/zktx-io/slsa-github-generator-test/delegator-generic@v0"`                                      | Identifies a the GitHub Actions build.                                                                                                                                                                                 |
