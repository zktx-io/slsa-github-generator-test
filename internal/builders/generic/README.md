...
provenance:
  ...
  uses: zktx-io/slsa-github-generator-test/.github/workflows/generator_generic_slsa3.yml@v2.0.0
  with:
...
The you must then share this file with the generator using the [actions/generator/generic/create-base64-subjects-from-file Action](https://github.com/zktx-io/slsa-github-generator-test/tree/main/actions/generator/generic/create-base64-subjects-from-file):
...
build:
  ...
  ...
    uses: zktx-io/slsa-github-generator-test/actions/generator/generic/create-base64-subjects-from-file@v2.0.0
    id: hashes
    with:
...
The [generic workflow](https://github.com/zktx-io/slsa-github-generator-test/blob/main/.github/workflows/generator_generic_slsa3.yml) accepts the following inputs:
...
The [generic workflow](https://github.com/zktx-io/slsa-github-generator-test/blob/main/.github/workflows/generator_generic_slsa3.yml) produces the following outputs:
...
| ---------------------------- | ---------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `buildType`                  | `"https://github.com/zktx-io/slsa-github-generator-test/generic@v1"` | Identifies a generic GitHub Actions build.                                                                                                                                                                             |
...
```json
{
  ...
  "predicate": {
    "builder": {
      "id": "https://github.com/zktx-io/slsa-github-generator-test/.github/workflows/generator_generic_slsa3.yml@refs/tags/v1.2.2"
    },
...
See issue
[#1702](https://github.com/zktx-io/slsa-github-generator-test/issues/1702) for
more details.
...
This issue is currently tracked by [issue #1163](https://github.com/zktx-io/slsa-github-generator-test/issues/1163)
