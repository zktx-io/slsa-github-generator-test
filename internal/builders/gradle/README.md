...
Availability via
[this milestone](https://github.com/zktx-io/slsa-github-generator-test/milestone/15).
...
jobs:
  build:
    permissions:
      ...
      contents: read
      actions: read
    uses: zktx-io/slsa-github-generator-test/.github/workflows/builder_gradle_slsa3.yml@v2.0.0
    with:
      artifact-list: >-
        ./build/artifact1.jar,
        ./build/artifact2.jar
