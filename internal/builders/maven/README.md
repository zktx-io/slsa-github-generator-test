...
Availability via
[this milestone](https://github.com/zktx-io/slsa-github-generator-test/milestone/17).
...
jobs:
  build:
    permissions:
      ...
      contents: read
      actions: read
    uses: zktx-io/slsa-github-generator-test/.github/workflows/builder_maven_slsa3.yml@v2.0.0
```
...
You can also release artifacts to Maven Central with [the slsa-github-generator Maven publish action](https://github.com/zktx-io/slsa-github-generator-test/blob/main/actions/maven/publish/README.md).
