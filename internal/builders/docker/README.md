...
[beta testing](https://github.com/zktx-io/slsa-github-generator-test/milestone/4).
...
The [container-based
workflow](https://github.com/zktx-io/slsa-github-generator-test/blob/main/.github/workflows/builder_container-based_slsa3.yml)
...
jobs:
  ...
  build:
    ...
    needs: args
    uses: zktx-io/slsa-github-generator-test/.github/workflows/builder_container-based_slsa3.yml@v2.0.0
    with:
      builder-image: "bash"
...
The [container-based
workflow](https://github.com/zktx-io/slsa-github-generator-test/blob/main/.github/workflows/builder_container-based_slsa3.yml) produces the following outputs:
...
```json
{
  ...
  "predicate": {
    ...
    "runDetails": {
      "builder": {
        "id": "https://github.com/zktx-io/slsa-github-generator-test/.github/workflows/builder_container-based_slsa3.yml@refs/tags/v1.5.0"
      },
      "metadata": {
...
go run *.go  dry-run \
  ...
  --source-repo git+https://github.com/zktx-io/slsa-github-generator-test \
