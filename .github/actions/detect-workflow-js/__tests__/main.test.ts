...
describe("detectWorkflowFromContext", () => {
  ...
  it("success", async () => {
      ...
      Promise.resolve({
        data: {
          referenced_workflows: [
            ...
            {
              path: "zktx-io/slsa-github-generator-test/.github/workflows/builder_docker-based_slsa3.yml@v1.5.0",
    ...
    expect(repo).toBe("zktx-io/slsa-github-generator-test");
    ...
    octokit.rest.actions.getWorkflowRun.mockReturnValue(
      Promise.resolve({
        data: {
          referenced_workflows: [
            {
              path: "zktx-io/slsa-github-generator-test/.github/workflows/generic_generator_slsa3.yml@v1.5.0",
              sha: "7f4fdb871876c23e455853d694197440c5a91506",
              ref: "refs/tags/v1.5.0",
            },
            {
    ...
    octokit.rest.actions.getWorkflowRun.mockReturnValue(
      Promise.resolve({
        data: {
          ...
          referenced_workflows: [
            {
              path: "zktx-io/slsa-github-generator-test/.github/workflows/builder_docker-based_slsa3.yml@9929152897cce5842f58221572911e18dd937808",
          ...
          repository: {
            ...
            full_name: "zktx-io/slsa-github-generator-test",
          },
          head_repository: {
            name: "slsa-github-generator",
