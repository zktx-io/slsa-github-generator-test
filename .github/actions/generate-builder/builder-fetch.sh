...
#BUILDER_REPOSITORY="zktx-io/slsa-github-generator-test"
...
if [[ "$builder_tag" != "$(echo -n "$builder_tag" | grep -oe '^v[1-9]\+\.[0-9]\+\.[0-9]\+\(-rc\.[0-9]\+\)\?$')" ]]; then
  ...
  echo "For details see https://github.com/zktx-io/slsa-github-generator-test/blob/main/README.md#referencing-slsa-builders-and-generators"
  exit 7
fi
